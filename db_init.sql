USE Pinboard;
CREATE TABLE IF NOT EXISTS `NewsObject`(`ID` INT NOT NULL AUTO_INCREMENT,`Title` VARCHAR(255) NOT NULL,`Date` VARCHAR(20) NOT NULL,`Filepath` VARCHAR(255) NOT NULL,`Link` VARCHAR(255),PRIMARY KEY (`ID`)) DEFAULT CHARSET=utf8;
