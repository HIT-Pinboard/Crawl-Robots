...
news_index = main_thread.get('http://jwc.hit.edu.cn/news/sub_tzgg.asp?cataid=A00340009')
...
stop_index = 0
stop_link = nil
filePath = 'jwc.hit.edu.cn/announcement/last_update.json'
...
while !should_stop do
	...
	table.each do |cell|
		news_title = cell.search('a[1]').text.strip
		news_link = base_url + cell.search('a[1]')[0]['href']
		...
		news = NewsObject.new(HNDepart::JWC, HNType::ANNOUNCEMENT, obj)
		news.save
		stop_index += 1
	end
