...
news_index = main_thread.get('http://sme.hit.edu.cn/news/main.asp?cataid=A00010004')
...
stop_index = 0
stop_link = nil
filePath = 'sme.hit.edu.cn/announcement/last_update.json'
...
while !should_stop do
	...
	table.each do |cell|
		...
		puts cell.search('td[2]//a')[0]['href']
		news_date = cell.search('td[2]//a')[1]['title']
		puts cell.search('td[2]//a')[1]['title']
		if stop_link == nil
			stop_link = news_link
		end
